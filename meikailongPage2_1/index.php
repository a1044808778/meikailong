...
$appid = "wx2509912ba7f80c16";
$appsec = "b4812ae49f288b52e4e2a852ca4e1142";
...
<title>红星美凯龙 | 独家冠名天猫超级晚，斑斓幻境炫酷出圈</title>
...
<body>
    <div class='wap-wrap'>
        ...
        <video class='pi p04' poster="./images/videoCover.jpg" controls>
            <source src="http://cdn.asdfin.com/video.mp4" type="video/mp4"> 
        </video>
        ...
        */
        ...
        wx.ready(function () {   //需在用户可能点击分享按钮前就先调用
            ...
            var shareInfo_appMessage = {
                title: '红星美凯龙 | 独家冠名天猫超级晚，斑斓幻境炫酷出圈', // 分享标题
