...
let redirect_uri = 'http://rs-wx.sny7.com/wxopenid/oauth4/auth.ashx';
let redirect_uri1 = 'http://rs-wx.sny7.com/wxopenid/oauth4/authUserInfo.ashx';
let jump_url = 'http://page.ctrlc.cc/meikailongPage1';
...
//let redirect_uri = 'http://wenjiaweb.chinaredstar.com/wxopenid/oauth4/auth.ashx';
//let jump_url = 'http://asdfin.com/meikailong/meikailongPage1/index.html';
...
function tracker_p(params) {
    ...
    data.pageAndUserView({
        ...
        p_v1: getPV1(),
        p_v2: getPV2(),
        p_id: '3ecc4a7bc70d58dbd036b5b847fcf0b0',
        u_guid: getGuid(),
        u_mid: getOpenid()
    })
}
...
$(window).unload(function(){
    console.log('unload');
    tracker_z({id: '10094', p_stay_time: new Date() - showTime})
});
...
//        }
    var shareInfo_appMessage = {
        title: '红星美凯龙 | 拎包入住', // 分享标题
        desc: '美凯龙高端整装正式上线!活动时间:2月10日-4月30日', // 分享描述
//            link: url, // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
        imgUrl: 'http://tf.redstarbuy.com/static/home/images/page_1.png', // 分享图标

        link: (url.indexOf("?") != -1)?url+'&parentCode='+(encrypt_unionid_openid()):url+'?parentCode='+(encrypt_unionid_openid()),//传播的链接地址里面包含参数：parentCode;
...
//                    alert('分享成功!');
                ...
                data.clickEvent({
                    id: '9293',
                    service: "h5",//微信环境内定义为wx,小程序环境内定义为miniProgram,其他环境定义为 h5
                    p_url: (url.indexOf("?") != -1)?url+'&parentCode='+(encrypt_unionid_openid()):url+'?parentCode='+(encrypt_unionid_openid()),
                    r_url: '',//上一个页面url,若没有可不传
                    u_id: '', //红星的用户id
                    u_mid: getOpenid(),//微信的openid
                    u_guid: '1t394jf4riu6eqhrsnst5plpj7',//访问sessionid
                    ...
                    p_id: '3ecc4a7bc70d58dbd036b5b847fcf0b0', //任务码
